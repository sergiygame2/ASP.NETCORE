...
namespace PagesCRUD.Data.Migrations
{
    ...
    [Migration("20160809110305_ModelsAndClasses")]
    partial class ModelsAndClasses
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PagesCRUD.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("PagesCRUD.Models.RelatedPages", b =>
                {
                    b.HasOne("PagesCRUD.Models.Page", "Page1")
                        .WithMany()
                        .HasForeignKey("Page1PageID");

                    b.HasOne("PagesCRUD.Models.Page", "Page2")
                        .WithMany()
